> Archived 2026-06-26.
>
> This is a point-in-time external/Kimi-style take on V5. It is useful
> historical reasoning, but it is not the current source of truth. The later
> V5 deterministic diagnostic and V6/V7 fixes narrowed the main V5 collapse
> mechanism to coarse-to-fine fine-stage spatial blindness, then added the
> fine skip connection, bf16 AMP, Ray eval normalizer sync, and reward repairs.
> See `docs/current/V5_COLLAPSE_AUDIT.md` and `docs/current/REPO_STATE.md`.
